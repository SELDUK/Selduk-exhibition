...
enum Image {
    ...
    static let expressionBar3 = UIImage(named: "expressionBar3")!
    static let expressionBar4 = UIImage(named: "expressionBar4")!
    static let expressionBar5 = UIImage(named: "expressionBar5")!
    static let expressionBar6 = UIImage(named: "expressionBar6")!
    static let expressionBar7 = UIImage(named: "expressionBar7")!
    static let expressionBar8 = UIImage(named: "expressionBar8")!
    static let expressionBar9 = UIImage(named: "expressionBar9")!
    static let expressionBar10 = UIImage(named: "expressionBar10")!
    static let expressionBar11 = UIImage(named: "expressionBar11")!
    static let expressionBar12 = UIImage(named: "expressionBar12")!
    static let expressionBar13 = UIImage(named: "expressionBar13")!
